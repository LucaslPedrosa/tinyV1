                                   ...
                                   const char *p_civilization = GREECE)
{
  ...
  return humanoid_root(p_civilization) + p_unit_folder + "/" + HUMANOID_PART_FILES[p_part_index];
}

inline godot::String humanoid_face(const char *p_unit_folder, const char *p_civilization = GREECE)
{
...
inline godot::String humanoid_item(const char *p_category_folder, const char *p_item_name,
                                   const char *p_civilization = GREECE)
{
  return humanoid_root(p_civilization) + "_tools/" + p_category_folder + "/" + p_item_name + ".png";
}
...
inline godot::String building_face(const char *p_building_name, const char *p_civilization = GREECE)
{
  return civilization_root(p_civilization) + "b_" + p_building_name + "/" + p_building_name +
         "_face.png";
}
...
{
  return godot::String("res://assets/world/") + p_resource_name + "/" + p_resource_name + ".png";
}
